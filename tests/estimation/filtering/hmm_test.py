...
class TestHmmFilter:
    ...
    def test_hmm_filter_update_and_predict(self, hmm_filter: HmmFilter) -> None:
    ...
    def test_hmm_filter_with_matrices_is_immutable(self, hmm_filter: HmmFilter) -> None:
        ...
        updated = hmm_filter.with_transition_matrix(new_transition).with_emission_matrix(
            new_emission
        )
    ...
    def test_filtering_single_and_batch(self, hmm_filter: HmmFilter) -> None:
        ...
        batch_beliefs = filtering(hmm_filter, initial_beliefs, batch_observations)
